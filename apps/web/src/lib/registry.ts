...
/**
 * Every known I/K-bus device.  Full twins come first (alphabetical by name),
 * then stubs in address order.  Stubs appear in the bus registry so frames
 * addressed to them are accepted, but they have no decoded state or controls.
 */
